...
export class UsuarioComponent implements OnInit {
  ...
  validar(){
    ...
    if(this.user.perfil == ""){
      this.validperfil = false;
    }else{
      this.validperfil = true;
    }
  }
  ...
  ingresar() {
    ...
    if(this.validnombre==true && this.validemail==true && this.validclave==true && this.validperfil==true){
